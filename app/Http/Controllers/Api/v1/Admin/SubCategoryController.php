...
use App\Services\CategoryService\SubCategoryService;
...
class SubCategoryController extends Controller
{
     ...
     */
    public function store(SubCategoryStoreRequest $request): JsonResponse
    {
     ...
     * @throws \Throwable
     */
    public function update(SubCategoryUpdateRequest $request, string $id): JsonResponse
    {
